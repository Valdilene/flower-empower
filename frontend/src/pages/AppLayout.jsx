...
function AppLayout({ userMe, token }) {
              ...
              <div className="border-t border-white pb-3 pt-4">
                ...
                <div className="mt-3 space-y-1 px-2">
                  ...
                  <DisclosureButton
                    onClick={() => handleLogout()}
                    as="a"
                    className="block cursor-pointer rounded-md px-3 py-2 text-base font-medium text-white hover:bg-pink-700 hover:text-white"
                  >
                    Sign Out
                  </DisclosureButton>
                </div>
