    ...
    <div className="flex flex-col h-full items-center justify-start mt-40">
      ...
      >
        ...
        <div className="col-span-2 place-self-center justify-self-center">
          <button className="flex w-full justify-center rounded-md bg-purple-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-purple-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600">
            CHANGE PASSWORD
          </button>
        </div>
      </form>
