        ...
        <div className="space-y-12 sm:space-y-16">
          <div>
            ...
            <div className="grid p-10 lg:grid-cols-2  md:grid-cols-2 sm:grid-cols-1 gap-4 mt-10 space-y-8  pb-12">
              ...
              <button className="cursor-pointer lg:col-span-2 md:col-span-2 md:place-self-center md:justify-self-center  lg:place-self-center lg:justify-self-center rounded-xl bg-pink-500 px-8 py-2 text-white hover:bg-pink-600">
                {isPending
